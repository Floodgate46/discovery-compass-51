...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "JETECT ENTERPRISE QUESTIONNAIRE SYSTEM" },
      ...
      { property: "og:title", content: "JETECT ENTERPRISE QUESTIONNAIRE SYSTEM" },
      ...
      { name: "twitter:title", content: "JETECT ENTERPRISE QUESTIONNAIRE SYSTEM" },
